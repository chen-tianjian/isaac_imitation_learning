...
All the environments are registered in the `isaac_imitation_learning` extension. They start
...
def main():
    """Print all environments registered in `isaac_imitation_learning` extension."""
